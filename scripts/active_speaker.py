...
Usage dans edit_video.py :
    from scripts.active_speaker import detect_active_speaker, is_asd_available
    if is_asd_available():
...
try:
    ...
    lr_asd_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "LR-ASD")
