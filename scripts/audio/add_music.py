...
try:
    from scripts.audio.fetch_music import fetch_music, DEFAULT_MUSIC_DIR, needs_refresh
except ImportError:
    try:
        ...
        DEFAULT_MUSIC_DIR = os.path.join(
            os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "music"
        )
        needs_refresh = None
