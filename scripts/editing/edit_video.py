...
from scripts.core.ffmpeg_utils import get_best_encoder, create_ffmpeg_pipe
from typing import Callable

logger = logging.getLogger(__name__)
from scripts.vision.one_face import crop_and_resize_single_face, resize_with_padding, detect_face_or_body, crop_center_zoom, crop_to_smart_region
from scripts.vision.two_face import crop_and_resize_two_faces, detect_face_or_body_two_faces
try:
    from scripts.vision.face_detection_insightface import init_insightface, detect_faces_insightface, crop_and_resize_insightface, get_face_embedding, cosine_similarity
