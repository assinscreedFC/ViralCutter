...
def cut(
    ...
    def generate_segments(response, project_folder, skip_video, smart_trim=smart_trim,
        ...
        if scene_detection:
            try:
                from scripts.analysis.scene_detector import detect_scenes_for_segments
        ...
        def _cut_single_segment(i, segment, total):
            ...
            try:
                ...
                if smart_trim:
                    try:
                        from scripts.quality.smart_trim import snap_to_sentence_boundary
                        if words:
                ...
                if scene_detection and cached_scenes:
                    try:
                        from scripts.analysis.scene_detector import validate_cut_boundaries
