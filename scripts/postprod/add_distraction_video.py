...
from scripts.core.ffmpeg_utils import get_best_encoder, build_quality_params, _build_preset_flags, get_video_duration

logger = logging.getLogger(__name__)

try:
    from scripts.postprod.fetch_distraction import fetch_distraction, DEFAULT_DISTRACTION_DIR, needs_refresh
except ImportError:
    try:
        ...
        DEFAULT_DISTRACTION_DIR = os.path.join(
            os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "distraction"
        )
        needs_refresh = None
